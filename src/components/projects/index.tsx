...
export const PROJECTS = [
  { 
    ...
    long_description: "<p>The app creates an experience out of what was typically a disjointed open source experience. Programmers are able to discover github projects aligned with their interests, track their contribution history, and be inspired by way of a badge and achievements system.</p><p>With the integration of discovery, tracking, and collaboration, KodeGee seeks to make open source easier and more engaging for users.</p>",
    image: "/images/projects/kodegee_bg.png",
    screenshot: "/images/projects/kodegee.png",
    link: null,
    stackItems: ["React", "TypeScript", "Tailwind CSS", "Node.js", "PostgreSQL", "Express", "MongoDB"],
    github: null
  },
  { 
    name: "Bliddo",
    ...
    long_description: "<p>The Bliddo system is a full-scale platform that enables users to design, customize, and monitor their QR codes effortlessly. Through Bliddo, users can produce unique QR codes for multiple applications, including promotional activities, product packaging, event marketing, and more.</p>",
    ...
    stackItems: ["React", "TypeScript", "Tailwind CSS", "Flask", "Python", "MySQL"],
    github: null
  },
  { 
    ...
    long_description: "<p>Better Presence is a user-friendly online platform that allows users to develop and customize their activities on the Discord server. </p><p>The app also provides live previews, enabling you to preview your activity in advance and know what it will look like once shared with your friends and audience. With Better Presence, gamers, musicians, artists, and other content creators can freely express themselves and connect with their peers on the Discord server.</p>",
  ...
  },
  {
    ...
    long_description: "<p>In this case, I collaborated with my fellow students to refine LLMs which are open-source based on the specified applications. In this case, we used the cutting-edge technology in the realm of natural language processing and machine learning to fine-tune pre-trained LLMs to cater to our needs.</p><p> In order to achieve the best results, the task required the steps of data preprocessing, training the model, and evaluating its performance. Through this experience, we were able to gain insights on the pros and cons of LLMs and the challenges in refining them.</p>",
    ...
    stackItems: ["Python", "TensorFlow", "OpenCV"]
  },
  { 
    name: "Logo Detection (SIFT)",
    status: "Live",
    description: "Built a logo recognition pipeline using SIFT features and homography validation",
    long_description: "<p>In this project, the creation of a pipeline for logo recognition is carried out using SIFT features and homography verification for accurate detection of logos in images. To start the process, the extraction of SIFT features for the image and the logos dataset is carried out.</p><p>These characteristics are compared using nearest neighbor matching, which is validated by estimating homographies. The end outcome of such an analysis is a highly reliable logo recognition mechanism that will enable the recognition of logos despite adverse conditions like changes in scale and rotation, among others.</p>",
    image: "/images/project/background/bg4.png",
    screenshot: "/images/projects/github.png",
    link: null,
    stackItems: ["Python", "OpenCV"],
    github: {
      name: "Repo",
      url: "https://github.com/albedim/SIFT-logo-detector"
    }
  },
];
    ...
    <>
      <ContainerWithVerticalBorders>
        <div className="relative grid grid-cols-1 sm:grid-cols-2 gap-0">
          ...
          {PROJECTS.slice(0, actualLimit).map((p, i) => (
                ...
                <div className="flex flex-col gap-2 cursor-pointer group w-full">
                  ...
                  <div className="px-2 flex flex-col gap-1">
                    ...
                    <div className='flex gap-4 items-center'>
                      <div onClick={() => navigate(`/projects/${i+1}`)} className="flex items-center gap-1 select-none">
